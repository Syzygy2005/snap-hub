...
export const WIKI_GUIDES: WikiGuide[] = [
  ...
  },
  {
    ...
    sections:[
      {id:"ranked",title:"Ranked and Infinite",text:"The regular ladder uses cubes to track progress toward Infinite. After Infinite, Snap Points decide your place on the Infinite leaderboard: the more you hold, the higher you rank. Snap Hub preserves the official top 1,000 and its history; it does not contain every player. The September 2026 update also introduced cubes toward Infinite on free limited-time event reward tracks.",aliases:["ladder","snap points","infinite"],source:official("September 2026 progression update","patch-notes-september-15-2026")},
