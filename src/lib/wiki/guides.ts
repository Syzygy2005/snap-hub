...
export const WIKI_GUIDES: WikiGuide[] = [
  {
    slug: "basics", title: "How to play", summary: "Turns, locations, reveal order, snapping and knowing when to retreat.", reviewed: "2026-09-24",
    sections: [
      ...
      { id:"priority", title:"Reveal order and priority", text:"Priority is the community name for revealing first. The player winning more locations has it. If locations are even, the player with more total Power has it, and if that is tied too it is decided at random, which is why the first turn is a coin flip. The highlighted player name shows who has it before you commit a play. Your own cards reveal in the order you played them. An effect that removes an enemy card may work differently before and after that card reveals.", aliases:["initiative","reveal first"], source:priority },
  ...
  {
    slug:"game-modes", title:"Game modes", summary:"Ranked, Conquest, Friendly Battle and the changing rules of limited-time events.", reviewed:"2026-09-24",
    sections:[
      {id:"ranked",title:"Ranked and Infinite",text:"The regular ladder uses cubes to track progress toward Infinite. After Infinite, you keep winning and losing cubes against other Infinite players and hold a numbered rank on the Infinite leaderboard, where a lower number is better. Snap Hub preserves the official top 1,000 and its history; it does not contain every player. The September 2026 update also introduced cubes toward Infinite on free limited-time event reward tracks.",aliases:["ladder","snap points","infinite"],source:official("September 2026 progression update","patch-notes-september-15-2026")},
      ...
      {id:"sanctum-showdown",title:"Sanctum Showdown",text:"Control locations to earn points over successive turns, racing to the target score. The Sanctum is worth extra points and moves each turn, so the lane worth fighting for changes as the game goes on. Event remixes can adjust the pace, so use the active event’s scoring display.",source:official("Sanctum Showdown introduction","new-limited-time-mode-sanctum-showdown")},
