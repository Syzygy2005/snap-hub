...
writeFileSync("src/app/icon.svg", `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 240"><rect width="240" height="240" rx="52" fill="${BRAND.forest}"/><g transform="translate(20 10)">${paths}</g></svg>\n`);
